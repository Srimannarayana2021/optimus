...
func (rm *ReplayManager) GetRunStatus(ctx context.Context, replaySpec models.ReplaySpec, jobSpec models.JobSpec) ([]models.JobStatus, error) {
	args := rm.Called(ctx, replaySpec, jobSpec)
